...
- What exists: deterministic double-pass recording, canonical lock persistence, raw probe descent, judged verification, bounded gating, artifacts, dependencies, fingerprints, blobs, and status.
