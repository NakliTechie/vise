...
8. [`pin.md`](pin.md) — a spec written before the code: unmet, build, accept, drift.
9. [`example.md`](example.md) — the shipped agent-ready template, instantiated and gated.
10. [`dogfood.md`](dogfood.md) — vise gates a source change in a clone of itself.
11. [`internal-checks.md`](internal-checks.md) — unit, integration, and static checks.
