...
Copy these two files, adjust the build command, and copy `AGENTS.md` from the
repository root next to them. Then run the handover test before giving an agent
any work:
